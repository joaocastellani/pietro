...
SECAO_PATTERNS = {
    ...
    "SEÇÃO 1":  r"#+\s*SEÇÃO\s*1(?!\d)",
    "SEÇÃO 2":  r"#+\s*SEÇÃO\s*2(?!\d)",
    "SEÇÃO 3":  r"#+\s*SEÇÃO\s*3(?!\d)",
    "SEÇÃO 4":  r"#+\s*SEÇÃO\s*4(?!\d)",
    "SEÇÃO 5":  r"#+\s*SEÇÃO\s*5(?!\d)",
    "SEÇÃO 6":  r"#+\s*SEÇÃO\s*6(?!\d)",
    "SEÇÃO 7":  r"#+\s*SEÇÃO\s*7(?!\d)",
    "SEÇÃO 8":  r"#+\s*SEÇÃO\s*8(?!\d)",
    "SEÇÃO 9":  r"#+\s*SEÇÃO\s*9(?!\d)",
