...
11. Informe:
    ...
    - `mindmap_fis[u][c].html` → adicionar ao knowledge base"
...
**a) HEADER** — fundo #4a2080:
- "Física · Unidade X · Capítulo Y · 9º ano"
- Título do capítulo (32px bold)
- "Mapa Mental — gerado na preparação"
- Legenda: verde=Dominado · vermelho=Reforçar · roxo=Não testado

**b) PÍLULA CENTRAL** — tema, fundo #4a2080

**c) GRID DE CARDS** — um por tópico, todos roxo:
...
**d) DICAS DE OURO** — fundo #F5F0FF, borda #9070C0,
