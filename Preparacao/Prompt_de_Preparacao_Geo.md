...
**Fontes:**
- SEÇÃO ATIVIDADES do `geo-[u]-[c].md` → Questões de Atividades (Origem: AT)
...
11. Informe:
    ...
    - `mindmap_geo[u][c].html` → referência visual (não vai para o KB)"
