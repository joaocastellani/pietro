# PROMPT DE CAPTURA — HISTÓRIA (9º ano)
# Arquivo gerado: his-[unidade]-[capitulo].md

---

Tarefa: Extraia todo o conteúdo desta página de História e gere um
...
- Para documentos históricos, discursos e fontes primárias:
  capture o conteúdo textual visível completo
- IMAGENS ANEXADAS: se imagens da apostila forem anexadas junto
  com este prompt, extraia o conteúdo textual visível nelas —
  legendas de fotografias, títulos de gravuras, datas e contextos
  de imagens históricas, dados de mapas históricos, textos em
  cartazes ou documentos reproduzidos — e incorpore nas seções
  correspondentes. Não ignore imagens anexadas.
...
conceito → Seção 2). Se o conteúdo for ilegível por ser imagem,
registre na seção IMAGENS RECOMENDADAS PARA CAPTURA.

SEÇÃO FINAL OPCIONAL — IMAGENS RECOMENDADAS PARA CAPTURA:
Se identificar fotografias, gravuras, mapas históricos, cartazes
ou documentos cujo conteúdo não foi possível extrair por texto
(ex: mapa histórico sem legenda legível, fotografia sem legenda),
...
Ex:
## IMAGENS RECOMENDADAS PARA CAPTURA
- Mapa da Europa pós-Congresso de Viena · fronteiras e países
  formados após 1815 · necessário para contextualizar transformações
  territoriais do capítulo
- Fotografia da Revolução Industrial · condições de trabalho ·
  necessária para contextualizar as condições dos operários
...
- Qualquer fonte que não seja tabela com linhas e colunas
  literalmente visíveis no material
...
[Execute se o capítulo apresentar mapas com contexto histórico —
fronteiras de época, rotas, divisões territoriais, zonas de conflito.]

Para cada mapa:
- Título do mapa (conforme o material)
- Período histórico representado
- Legenda: capture todos os elementos visíveis
