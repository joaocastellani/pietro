...
Arquivos de entrada: `art-[u]-[c].md` + `art-[u]-[c]-questoes.md`
...
1. Use `project_knowledge_search` para localizar e ler
   `art-[u]-[c].md` e `art-[u]-[c]-questoes.md` inteiros
...
1. Leia `art-[u]-[c].md` e `art-[u]-[c]-questoes.md` inteiros
...
11. Informe:
    ...
    - `mindmap_art[u][c].html` → adicionar ao knowledge base"
...
**a) HEADER** — fundo #7B2D8B:
- "Artes · Unidade X · Capítulo Y · 9º ano"
...
**b) PÍLULA CENTRAL** — tema, fundo #7B2D8B
...
- Para movimentos: período + características + artistas
- Para obras: ficha técnica compacta + elemento formal central
- Para artistas: movimento + obras + contribuição
- Para análise formal: obra + elementos visuais em bullets

**d) DICAS DE OURO** — fundo #FFF0FF, borda #7B2D8B,
...
- Cor primária: #7B2D8B (roxo de Artes)
