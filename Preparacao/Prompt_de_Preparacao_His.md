...
**Fontes:**
- SEÇÃO ATIVIDADES do `his-[u]-[c].md` → Questões de Atividades (Origem: AT)
...
11. Informe:
    ...
    - `mindmap_his[u][c].html` → referência visual (não vai para o KB)"
